...
<html lang="en">
  ...
  <!--<![endif]-->
    ...
    <div class="navbar" <?php if($this->input->cookie('lang_current')=='zh-hans') echo  "style='font-family: 微软雅黑;'" ?>>
        <div class="navbar-inner">
                <ul class="nav pull-right">
					...
					?>
                    <li <?php if($model=='index'){ echo "class='active'";} ?> ><a href="<?php echo site_url('index/monlist'); ?>" class="hidden-phone visible-tablet visible-desktop" role="button"><?php echo $this->lang->line('dashboard'); ?></a></li>
    ...
    <div class="sidebar-nav" <?php if($this->input->cookie('lang_current')=='zh-hans') echo  "style='font-family: 微软雅黑;'" ?> >
        <a href="<?php echo site_url('index/monlist')?>" class="nav-header" ><i class="icon-comment"></i><?php echo $this->lang->line('dashboard'); ?></a>
        <?php if (isset($menus)):?>
