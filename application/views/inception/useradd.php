...
<ul class="breadcrumb">
            ...
            <li class="active"><?php echo $this->lang->line('_Line user'); ?></li>            
</ul>

<div class="container-fluid">
    <div class="row-fluid">
        <?php echo validation_errors()?>
        <form name="form" class="form-horizontal" method="post" action="<?php echo site_url('inception/useradd') ?>" >
            <input type="hidden" name="submit" value="useradd"/> 
